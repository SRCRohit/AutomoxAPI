...
<div class="panel panel-inverse">
    ...
    <div class="panel-body">
        <div>
            <form action="{{ route('companyview')  }}" method="get">
            ...
            <table id="data-table-default" class="table table-striped table-bordered align-middle">
                <thead>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $UserCounts->company_id }}</td>
                            <td>{{ $UserCounts->createdAt->format('Y-m-d') }} | {{ $UserCounts->updatedtime->format('H:i:s') }}</td>
                            <td>{{ $UserCounts->company_name }}</td>
                            <td>{{ $UserCounts->msp }}</td>
                            <td class="text-center">{{ $UserCounts->license_issue_date }}</td>
