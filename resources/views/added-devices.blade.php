...
@section('content')
    <div class="panel panel-inverse">
        <div class="panel-heading">
            <h4 class="panel-title">Added Devices</h4>
        </div>
        <div class="panel-body">
            <div>
                <form action="{{ route('addeddevices')  }}" method="get">
...
//                                            $organisationHTML .= '<optgroup label="'.$company->name.'">'.$option.'</optgroup>';
            ...
            <div style="margin-top : 1rem">
                <table id="data-table-default" class="table table-striped table-bordered align-middle" style="text-align: center";>
                    <thead>
                    <tr>
                        <th data-orderable="True">Device ID</th>
                        <th data-orderable="True">Device Name</th>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Added Devices : <span id="for-user"
...
@section('javascript')
    ...
    <script type="text/javascript">
        ...
        function getUserActivity(userid) {
            ...
            $.post('{{ route('addeddevices')  }}',{ _token : $('meta[name=csrf-token]').attr('content') ,
